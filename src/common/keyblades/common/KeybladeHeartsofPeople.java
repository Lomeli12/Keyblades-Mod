...
public class KeybladeHeartsofPeople extends ItemSword{
	protected KeybladeHeartsofPeople(int i, EnumToolMaterial enumtoolmaterial)
	{
	...
	{
		Living1.addPotionEffect(new PotionEffect(19, 100, 1));
		Living1.addPotionEffect(new PotionEffect(7, 100, 1));
		return true;
	}
